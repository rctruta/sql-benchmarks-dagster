...
def load_active_config():
    ...
    Returns: (engines, tables_list, meta)
    """
...
def get_tables_used_in_sql(sql_path, valid_tables_set):
    """
    Parses a SQL file using Jinja2 AST to find undefined variables.
    Returns a list of table names that match the valid_tables_set.
    """
    ...
    for var in required_vars:
        # Expecting variables like 'orders_table'
